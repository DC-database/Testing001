(function () {
  ...
  function printDocument(title, bodyHTML) {
    ...
    const mobileToolbar = mobile ? `<div class="document-mobile-toolbar"><div><strong>PDF-ready document</strong><span>Save as PDF or share from your phone. Official printing is completed from desktop.</span></div><button type="button" onclick="window.print()">Save PDF</button><button type="button" onclick="window.close()">Close</button></div>` : "";
