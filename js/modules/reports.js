(function () {
  ...
  async function render(view) {
    view.innerHTML = `
      <section class="page-heading"><div><div class="eyebrow">PRINT & PDF READY</div><h1>Reports</h1><p>Every report is generated from the current local records. The production version will use the same templates with Firebase data.</p></div></section>
  ...
  async function buildReport(reportId) {
    ...
    const footer = `<div class="footer">59 Real Estate · Confidential · Generated from local demo records · ${u.dateTime(Date.now())}</div>`;
