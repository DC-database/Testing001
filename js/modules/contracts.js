  ...
  async function render(view, params = {}) {
    ...
    view.innerHTML = `
      <section class="page-heading">
        <div><div class="eyebrow">LEASE MANAGEMENT</div><h1>Contracts</h1><p>Active, upcoming and historical contracts with direct access to the corresponding unit folder.</p></div>
