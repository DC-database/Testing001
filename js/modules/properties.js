(function () {
  ...
  const PROPERTY_PLACEHOLDERS = {
    "property-r16": "assets/images/properties/marina-tower-16.jpg",
    "property-r19": "assets/images/properties/r19-tower.jpg",
    "property-foxhills": "assets/images/properties/foxhills.jpg",
    "property-a29": "assets/images/properties/building-a29.jpg",
    "property-villas": "assets/images/properties/stand-alone-villas.jpg",
    "property-nb1": "assets/images/properties/nb1-residence.jpg",
    "property-muntazah": "assets/images/properties/muntazah-building.jpg",
    "property-mansoura": "assets/images/properties/al-mansoura-46.jpg",
    "property-ghazal": "assets/images/properties/al-ghazal-compound.jpg",
    "property-umm": "assets/images/properties/umm-ghuwailina-b5.jpg",
    "property-store": "assets/images/properties/store-birkat-al-awamer.jpg"
  };
  ...
  async function renderPropertyList(view, params = {}) {
    ...
    view.innerHTML = `
      <section class="page-heading property-page-heading">
        <div><div class="eyebrow">PRIVATE PROPERTY PORTFOLIO</div><h1>Properties &amp; Units</h1><p>Manage every asset, unit and occupancy record from one clear portfolio view.</p></div>
      ...
      <section class="portfolio-browser-section">
        <header class="section-title-row">
          <div><div class="eyebrow">PROPERTY COLLECTION</div><h2>Browse the portfolio</h2><p>The status tabs show the real unit records, not repeated property summaries.</p></div>
        </header>
        ...
        <div class="property-photo-notice">
          ...
          <div><strong>Property images are demo placeholders.</strong><span>Open Edit property &amp; photo to replace any image with the official property photograph.</span></div>
    ...
    const instance = root.ui.openModal({
      ...
      content: `<form id="property-form" class="form-grid">
        ...
        <div class="span-2 property-photo-field">
          ...
          <label><span>Property cover photo</span><input name="coverPhoto" type="file" accept="image/jpeg,image/png,image/webp"><small>JPG, PNG or WebP. The system stores a compressed copy in this local demo.</small></label>
        </div>
      </form>`,
