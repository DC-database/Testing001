(function () {
  ...
  async function boot() {
    ...
    bindStaticEvents();
    root.ui.showLoading("Preparing local demo database…");
    try {
  ...
  function updateUserInterface(user) {
    ...
    document.getElementById("topbar-user-initials").textContent = initials;
    ...
    document.getElementById("topbar-user-role").textContent = user.roleLabel;
  }
