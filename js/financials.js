  ...
  async function render(view, params = {}) {
    ...
    view.innerHTML = `
      <section class="page-heading">
        ...
        <div class="page-actions"><button class="button button-secondary" data-print-register>${root.ui.documentActionText("Print payment schedule", "PDF payment schedule")}</button></div>
      </section>
